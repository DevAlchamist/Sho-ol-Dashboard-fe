...
import { Sheet, SheetTrigger, SheetContent } from "@/components/ui/sheet"; // Adjusted imports to include specific Sheet components
...
const NavBar = () => {
  ...
  return (
    <div className="w-full">
      <div className="text-black/90 border bg-transparent w-full p-5 flex items-center justify-between gap-5">
        <div className="text-black/90 flex items-center">
          <div className="flex items-center font-bold gap-4 text-[20px]">
            <svg
              width="48"
              height="54"
              viewBox="0 0 48 54"
        ...
        <div className="flex items-center gap-5">
          <Sheet open={drawerOpen} onOpenChange={setDrawerOpen}>
            ...
            <SheetContent side="right" onClick={toggleDrawer(false)}>
              {list()}
            </SheetContent>
          </Sheet>
